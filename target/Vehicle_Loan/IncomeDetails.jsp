				...
				<div class="signup-content">
					...
					<div class="signup-form">
						...
						<div class="form-group">
							<label for="type for employment">Type Of Employment :</label> <input
								type="text" id="typeofemployment" name="typeOfEmployment"
								required readonly />
						</div>

						<div class="form-group">
							<label for="annual income">Annual Income :</label> <input
								type="text" id="annualincome" name="annualIncome" required
								readonly />
						</div>
						<div class="form-group">
							<label for="existing EMI">Existing EMI :</label> <input
								type="text" id="existingemi" name="existingEmi" required
								readonly />
						</div>
						<hr noshade>
