				...
				<div class="login-panel panel panel-default">
					...
					<div class="panel-body">
						<form role="form" name="forgetpassword"
							action="checksecurityanswer" method="post"
									...
									<div class="form-group">
										<div class="wrap-input100 validate-input"
											...
											<label><i class="fa fa-envelope" aria-hidden="true"></i>
												E-mail</label> <input class="form-control" type="text" name="email"
												value="${fp.email}" readonly><br>
										</div>
									</div>

									<div class="form-group">
										<div class="wrap-input100 validate-input">
											<label><i class="fa fa-envelope" aria-hidden="true"></i>Security
												Question</label> <input class="form-control" type="text" name="que"
												value="${fp.que}" readonly><br>
										</div>
									</div>
									<div class="form-group">
										<div class="wrap-input100 validate-input">
											<label><i class="fa fa-envelope" aria-hidden="true"></i>Security
												Answer</label> <input class="form-control" type="text" name="ans"><br>
										</div>
									</div>
