...
<head>
<title>Vehicle Loan | About</title>
	...
	<section class="welcome py-5">
		<div class="container py-md-4 mt-md-3">
			<h2 class="heading-agileinfo">
				About Us <span>We offer the best deals for your Car Loan!</span>
			</h2>
			<span class="w3-line black"></span>
			<div class="row about-tp mt-md-5 pt-5">
				<div class="col-lg-6 welcome-left">
					<h3>Welcome</h3>
					<h4>We are committed to offering the highest quality,
						...
						not just owning the car but making their dreams come true.</h4>
					<p>Our single-minded focus on product quality and services
						excellence has helped us garner the appreciation of both national
	...
	<section class="team py-5">
		<div class="container py-md-4 mt-md-3">
			<h3 class="heading-agileinfo">
				Our Team <span>Individual commitment to a group effort--that
					is what makes our team work, a company work,a civilization work</span>
			</h3>
			<span class="w3-line black"></span>
			<div class="row team-row-agileinfo mt-md-5 pt-5">
				<div class="col-lg-3 col-md-6 col-sm-6 team-grids">
					<div class="thumbnail team-agileits">
						...
						<div class="effectd-caption">
							<h4 class="mb-3">Sharad Patel</h4>
							<div class="social-lsicon"></div>
						</div>
					</div>
				</div>
				<div class="col-lg-3 col-md-6 col-sm-6 team-grids">
				...
				<div class="col-lg-3 col-md-6 col-sm-6 team-grids">
					<div class="thumbnail team-agileits">
						...
						<div class="effectd-caption">
							<h4 class="mb-3">Sidharth Kaul</h4>
							<div class="social-lsicon"></div>
						</div>
					</div>
				</div>
