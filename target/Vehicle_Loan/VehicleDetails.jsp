...
<body>
	...
	<form action="saveVehicle" method="POST">
		<div class="container">
			...
			<label for="Car Make"><b>Car Make</b></label> <input type="text"
				placeholder="" name="carMake" id="carMake" required readonly>

			<label for="Car Model"><b>Car Model</b></label> <input type="text"
				placeholder="" name="carModel" id="carModel" required readonly>

			<label for="Ex Showroom Price"><b>Ex Showroom Price</b></label> <input
				type="text" placeholder="" name="exShowroomPrice"
				id="exShowroomPrice" required readonly>
			<hr>
