			...
			<div class="col-md-4 col-md-offset-4">
				<div class="login-panel panel panel-default">
					...
					<div class="panel-body">
						<form role="form" name="formadmin" action="adminlogin"
							id="adminform" method="post" onsubmit="return checkform(this);">
							<fieldset>
								<div class="form-group">
									<label><i class="fa fa-envelope" aria-hidden="true"></i>
										E-mail</label> <input class="form-control" placeholder="E-mail"
										name="adminemail" type="email" autofocus
										oninvalid="this.setCustomValidity('Email Can Not be Empty')">
								</div>
								<div class="form-group">
									<label><i class="fa fa-key" aria-hidden="true"></i>
										Password</label> <input class="form-control" placeholder="Password"
										id="password" name="adminpassword" type="password"
										oninvalid="this.setCustomValidity('Password Can Not be Empty')">
