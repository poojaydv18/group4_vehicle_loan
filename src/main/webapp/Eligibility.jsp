...
<link type="text/css" rel="stylesheet" href="css/eligibility.css" />
...
<body>
		...
		<div class="content" style="width: 50%; margin: auto">
			<form method="post" action="Confirmation.jsp">
				...
				<div class="container" style="width: 95%;">
					...
					<br> <label for="Car Make"><b><i class="fa fa-car"
							aria-hidden="true"></i> Car Make</b></label>
					<div class='resp_code frms'>
						...
						<label for="Car Model"><b><i class="fa fa-car "
								aria-hidden="true"></i> Car Model</b></label>
						<div class='resp_code frms'>
					...
					<input type="number" min="1" max="100000000"
						oninput="validity.valid||(value='');" pattern="[1-9]{4-9}"
						id="exshowroomprice" name="Ex-Showroom Price"
						placeholder="Enter Value" title="enter number format" required><br>
					<br> <label><i class="fa fa-rupee-sign"></i> On Road
						Price</label> <input type="number" min="1" max="100000000"
						oninput="validity.valid||(value='');" pattern="[1-9]{4-9}"
						id="onroadprice" name="On Road Price" placeholder="Enter Value"
						title="enter number format" required><br>
					<hr>

					<div style="background-color: black; color: white; padding: 20px;">
						<h4>Applicant Details:</h4>
					</div>
					<br> <label><i class="fa fa-user" aria-hidden="true"></i>
						Name:</label> <input type="text" id="user" name="user"
						placeholder="Enter Full Name" required maxlength="32"
						pattern="[A-Za-z' ]{1,32}"><br>
					<br> <label><i class="fa fa-calendar"
						aria-hidden="true"></i> Age</label> <input type="number" id="age"
						name="age" placeholder="Enter your age" min="21" max="65" required><br>
					<br> <label><i class="fa fa-venus-mars"
						aria-hidden="true"></i> Gender:</label><br>
					<div class='resp_code frms'>
  ...
  <input type="radio" name="gender" id="other" value="other"> Other   -->
					...
					<br>
					<br> <label><i class="fa fa-user-plus"
						aria-hidden="true"></i> Type Of Employment:</label>
					<div class='resp_code frms'>
					...
					<br>
					<br> <label><i class="fa fa-rupee-sign"></i> Yearly
						Salary:</label> <input type="number" min="1" max="100000000"
						oninput="validity.valid||(value='');" pattern="[1-9]{4-9}"
						title="enter number format" id="yearlysalary" name="Yearly Salary"
						placeholder="Enter Yearly Salary" required><br>
					<br> <label><i class="fa fa-user" aria-hidden="true"></i>
						Existing EMI</label></br> <input type="number" min="0" max="100000000"
						oninput="validity.valid||(value='');" pattern="[1-9]{4-9}"
						title="enter number format" id="existingemi" name="Existing EMI"
						placeholder="Existing EMI" value="0"><br>
					<br>
					<hr>
					<div style="background-color: black; color: white; padding: 20px;">
						<h4>Contact Details</h4>
					</div>
					<br> <label><i class="fa fa-phone" aria-hidden="true"></i>
						Mobile No</label><br> <input type="text" pattern="[6-9]{1}[0-9]{9}"
						title="Please enter a valid mobile number" maxlength="10"
						id="mobile" name="mobile" placeholder="Enter Mobile No:" required><br>
					<br> <label><i class="fa fa-envelope"
						aria-hidden="true"></i> Email ID</label> <input type="text" id="email"
						name="" placeholder="Enter Email ID"
