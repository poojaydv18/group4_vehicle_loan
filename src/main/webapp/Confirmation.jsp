...
<body background="images/bg1.png";>
	<div class="container">
		...
		<ul class="list-group">
			<h1>
				<li class="list-group-item"><b>Hello: <span
						id="display_user"></span></li>
			</h1>
			<li class="list-group-item"><b> Car Make: <span
					id="display_carmake"></span></li>
			<li class="list-group-item">Car Model: <span
				id="display_carmodel"></span></li>
			<li class="list-group-item">Applied Loan Amount: <span
				id="display_exshowroomprice"></li>
			<li class="list-group-item">Employment Details: <span
				id="display_employment"></span></li>
			...
			<li class="list-group-item">Eligible Loan Amount: <span
				id="display_loanamount"></span>
				</p>
		</ul>
