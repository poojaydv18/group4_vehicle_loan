...
<html lang="en">
                ...
                <div class="col-md-4 col-md-offset-4">
                    <div class="login-panel panel panel-default">
                        ...
                        <div class="panel-body">
                             <form role="form" name="forgetpassword"   action="forgetchangepassword"  method="post" onsubmit="return checkform(this);">
                                <fieldset>
 ...
 <div class="form-group"><div class="wrap-input100 validate-input" data-validate = "Valid email is required: ex@abc.xyz">
                                        ...
                                        <input class="form-control" type="email" name="email" value="<%= session.getAttribute("email") %>" readonly><br>
                                  </div> 
                                    </div>
